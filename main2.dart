main() {
  ...
  huaweiP50Pro() {
    print(HuaweiP50Pro.RAM + "\n" + "Launch Date: " +HuaweiP50Pro.LaunchDate
        ...
        + "\n" +"Price: " +HuaweiP50Pro.Price.toString() +" Million Rial");

    (HuaweiP50Pro.PriceForIRRials());
    print("Price For Iranian Rial: " + HuaweiP50Pro.Price.toString()+"Million Rial"+"\n");
  }
  huaweiP50Pro();
  ...
  samsungGalaxyM62(){
    print(SamsungGalaxyM62.RAM + "\n" + "Launch Date: " +SamsungGalaxyM62.LaunchDate
        ...
        + "\n" +"Price: " +SamsungGalaxyM62.Price.toString()+" Million Rial");

    (SamsungGalaxyM62.PriceForIRRials());
    print("Price For Iranian Rial: " + SamsungGalaxyM62.Price.toString()+ " Million Rial");
  ...
  asusZenfone8() {
    print(AsusZenfone8.RAM + "\n" + "Launch Date: " +AsusZenfone8.LaunchDate
        ...
        + "\n" +"Price: " +AsusZenfone8.Price.toString()+" Million Rial");
  }
